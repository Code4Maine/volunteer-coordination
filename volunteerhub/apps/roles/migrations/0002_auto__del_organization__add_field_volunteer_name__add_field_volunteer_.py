...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'roles_volunteer', 'name',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'Volunteer.phone_number'
        db.add_column(u'roles_volunteer', 'phone_number',
        ...
        m2m_table_name = db.shorten_name(u'roles_volunteer_opportunities_completed')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('volunteer', models.ForeignKey(orm[u'roles.volunteer'], null=False)),
            ('opportunity', models.ForeignKey(orm[u'projects.opportunity'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'roles_volunteer', 'name')

        # Deleting field 'Volunteer.phone_number'
        db.delete_column(u'roles_volunteer', 'phone_number')

        # Removing M2M table for field opportunities_completed on 'Volunteer'
        db.delete_table(db.shorten_name(u'roles_volunteer_opportunities_completed'))
    ...
    models = {
        ...
        u'roles.volunteer': {
            ...
            'opportunities_completed': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['projects.Opportunity']", 'symmetrical': 'False'}),
