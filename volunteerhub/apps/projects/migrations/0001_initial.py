...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_organization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ...
        db.send_create_signal(u'projects', ['Organization'])

        # Adding model 'LaborType'
        db.create_table(u'projects_labortype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=50, separator=u'-', blank=True, populate_from='title', overwrite=False)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'projects', ['LaborType'])
        ...
        db.create_table(u'projects_opportunity', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ...
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(related_name='organization', to=orm['projects.Organization'])),
            ('labor_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.LaborType'], null=True, blank=True)),
        ))
        db.send_create_signal(u'projects', ['Opportunity'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'projects_organization')

        # Deleting model 'LaborType'
        db.delete_table(u'projects_labortype')

        # Deleting model 'Project'
        db.delete_table(u'projects_project')

        # Deleting model 'Opportunity'
        db.delete_table(u'projects_opportunity')
