...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VolunteerApplication'
        db.create_table(u'volunteers_volunteerapplication', (
        ...
        db.send_create_signal(u'volunteers', ['VolunteerApplication'])

        # Adding field 'Opportunity.fullfilled'
        db.add_column(u'volunteers_opportunity', 'fullfilled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Opportunity.max_applicants'
        db.add_column(u'volunteers_opportunity', 'max_applicants',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VolunteerApplication'
        db.delete_table(u'volunteers_volunteerapplication')

        # Deleting field 'Opportunity.fullfilled'
        db.delete_column(u'volunteers_opportunity', 'fullfilled')

        # Deleting field 'Opportunity.max_applicants'
        db.delete_column(u'volunteers_opportunity', 'max_applicants')
