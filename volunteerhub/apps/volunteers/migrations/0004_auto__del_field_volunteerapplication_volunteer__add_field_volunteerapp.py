...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VolunteerApplication.volunteer'
        db.delete_column(u'volunteers_volunteerapplication', 'volunteer_id')

        # Adding field 'VolunteerApplication.user'
        db.add_column(u'volunteers_volunteerapplication', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['custom_user.EmailUser']),
                      keep_default=False)

        # Adding field 'Volunteer.user'
        db.add_column(u'volunteers_volunteer', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['custom_user.EmailUser'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'VolunteerApplication.volunteer'
        raise RuntimeError("Cannot reverse this migration. 'VolunteerApplication.volunteer' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'VolunteerApplication.volunteer'
        db.add_column(u'volunteers_volunteerapplication', 'volunteer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['volunteers.Volunteer']),
                      keep_default=False)

        # Deleting field 'VolunteerApplication.user'
        db.delete_column(u'volunteers_volunteerapplication', 'user_id')

        # Deleting field 'Volunteer.user'
        db.delete_column(u'volunteers_volunteer', 'user_id')
    ...
    models = {
        ...
        u'volunteers.opportunity': {
            ...
            'max_applicants': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'volunteers.volunteer': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['custom_user.EmailUser']", 'null': 'True', 'blank': 'True'})
        },
        u'volunteers.volunteerapplication': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'VolunteerApplication'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'opportunity': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['volunteers.Opportunity']"}),
