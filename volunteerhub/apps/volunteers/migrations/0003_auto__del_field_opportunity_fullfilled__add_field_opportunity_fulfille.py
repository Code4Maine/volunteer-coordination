...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Opportunity.fulfilled'
        db.add_column(u'volunteers_opportunity', 'fulfilled',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Opportunity.fulfilled'
        db.delete_column(u'volunteers_opportunity', 'fulfilled')
