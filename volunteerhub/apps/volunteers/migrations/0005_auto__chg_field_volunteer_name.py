...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Volunteer.name'
        db.alter_column(u'volunteers_volunteer', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Volunteer.name'
        db.alter_column(u'volunteers_volunteer', 'name', self.gf('django.db.models.fields.TextField')(max_length=255))
